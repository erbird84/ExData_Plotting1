...
#plot 2, upper right hand corner
with(y, plot(DateTime, Voltage,
             type = "l",
             ylab = "Voltage",
             xlab = "datetime"
))
#plot 3, lower left hand corner
...
#plot 4, lower right hand corner
with(y, plot(DateTime, Global_reactive_power,
             type = "l",
